...
public class BookingDotCom {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Get and print the selected flight name
        WebElement selectedFlightName1 = driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div[2]/div[1]/div[2]/div/div[2]/div[1]/div/div[2]/div/div[2]/div[1]"));
        String selectedFlightName = selectedFlightName1.getText();
        System.out.println("Selected Flight Name: " + selectedFlightName);
